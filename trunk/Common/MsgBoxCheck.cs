...
// This class is based on the code project article by Mike scanlon available here:
// http://www.codeproject.com/KB/dialog/MessageBoxChk.aspx?msg=1169057
// This in turn makes use of the CbtHook and WindowsHook assemblies by Dino Esposito for MSDN magazine:
// http://msdn.microsoft.com/en-ie/magazine/cc188966(en-us).aspx

namespace EveMarketMonitorApp.Common
{
	public class ChkMessageBox
	{
		...
		public DialogResult Show(string strCheck, string strText, string strTitle, MessageBoxButtons buttons, MessageBoxIcon icon)
		{
		...
		public DialogResult Show(string strCheck, string strText, string strTitle, MessageBoxButtons buttons)
		{
			return Show(strCheck, strText, strTitle, buttons, MessageBoxIcon.None);
		}
		
		public DialogResult Show(string strCheck, string strText, string strTitle)
		{
			return Show(strCheck, strText, strTitle, MessageBoxButtons.OK, MessageBoxIcon.None);
		}
		
		public DialogResult Show(string strCheck, string strText)
		{
			return Show(strCheck, strText, "", MessageBoxButtons.OK, MessageBoxIcon.None);
		}
